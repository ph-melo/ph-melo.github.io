...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const translations = {
    pt: {
      ...
      auditoria: "Convidado a pedido da liderança sênior da área, com foco em Data Analytics aplicado à Auditoria, apoiando a Diretoria na tomada de decisão por meio de dados, indicadores e automação de análises. Responsável por desenvolver, estruturar e automatizar KPIs e análises avançadas, utilizando ferramentas analíticas e linguagens de programação para transformar grandes volumes de dados em insights relevantes para os processos de auditoria, mitigação de riscos e melhoria contínua dos controles internos.",
      careerFullstackDevDetails: "Atuei como desenvolvedor fullstack, onde fui responsável por projetar, desenvolver e manter aplicações web. Trabalhando tanto no frontend quanto no backend, utilizando tecnologias como JavaScript, HTML, CSS, Python e frameworks como Django e React, Java, Spring. Estou envolvido em todas as etapas do ciclo de desenvolvimento, desde a concepção até a implementação e manutenção das aplicações.",
